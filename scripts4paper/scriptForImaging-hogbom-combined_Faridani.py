...
if(mystep in thesteps):
  ...
  # high res, low res, pb name, and f (scaling factor)
  f = 1.0
  ...
  lowres_regrid = 'low.res.multiplied'
  ...
  immath([lowres_regrid, highres_conv], 'evalexpr', 'sub.im', '%g*IM0-IM1' % f)
  ...
  if getBunit(lowres_regrid) == 'Jy/beam':
    ...
    combined = highresbase + '_ssc_f%s_TP.image'  % f
...
if(mystep in thesteps):
  ...
  myimages = [highresbase + '_ssc_f%s_TP' % f]
