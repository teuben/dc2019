...
if(mystep in thesteps):
  ...
  mycell = 0.21 # arcsec
  myimsize = 1120
  myprimarybeamsize =  qa.constants('c')['value']/115E9/7./qa.constants('pi')['value']*180.*3600.
  myscales = [0]

  for i in range(1, int(math.log(myprimarybeamsize/mycell/2.,2))-1):
    myscales.append(2**i*mycell*5)

  print("My scales: "+str(myscales))

  os.system('rm -rf gmc_120L.alma.all_int-mfs.I.manual-multiscale-weighted2*')
  tclean(vis = thevis,
         imagename = 'gmc_120L.alma.all_int-mfs.I.manual-multiscale-weighted2',
         field = '0~68',
...
if(mystep in thesteps):
  ...
  myimages = ['gmc_120L.alma.all_int-mfs.I.manual-multiscale-weighted2']
