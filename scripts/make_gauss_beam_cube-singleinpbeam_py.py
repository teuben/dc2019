...
sdname = 'new.cube.spw23-forLeiden'

exportfits(imagename=sdname+'.image',fitsimage=sdname+'.fits')
...
nchans = hdulist[0].header['NAXIS3']        # number of chans
...
os.system('cp -r beams.im beams_axs.im')
...
for i in range(nchans): 
    ...
    majornum = bmaj*3600.    # the major axis FWHM of the beam
