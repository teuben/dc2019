...
if QAC.select(1,select,"Flux comparisons flum-cmp*png"):
    ...
    f6a =  imstat('M100_Feather_CO.image.pbcor',           axes=[0,1])['flux']             # Feather
...
if QAC.select(8,select,"tp2vis flux vs. niter M100_flux_niter.png "):        
    ...
    # redone with cycleniter=100 later
    data23 = []
    data23.append(0.513)
    data23.append((0, [0.0, 0.69069289908853526, 7.0445373956769428, 0.0, 3474.6588002213011, 3942.4144694553534]))
    data23.append((1, [66.862277023494244, 325.78284042457591, 326.63486592055318, 73.148224923759699, 3501.400407017768, 3951.0927311769378, 4096.8908900380166, 4630.3105197617297]))
    data23.append((10, [122.73669137177058, 607.50718791188694, 625.16119860712058, 135.60488770669326, 3520.2238899434915, 3959.6877787366911, 3992.3565506416849, 4499.9260385363759]))
    data23.append((30, [156.47085090912879, 779.48177461735725, 811.06505943729235, 178.05870513501577, 3531.0728899281548, 3964.2576086930803, 3945.3847602188798, 4439.2199388184208]))
    data23.append((100, [256.2222094561439, 1283.1631746255357, 1366.4426044978584, 574.97279657039326, 3584.9139452294194, 3950.1432550419891, 3674.5137890391456, 4051.4892647719435]))
    data23.append((300, [256.2222094561439, 1283.1631746255357, 1366.4426044978584, 574.97279657039326, 3584.9139452294194, 3950.1432550419891, 3674.5137890391456, 4051.4892647719435]))
    # data.append(data23)
    ...
    data23.append(0.513)
    data23.append((0, [0.0, 0.69069289908853526, 7.0445373956769428, 0.0, 3474.6588002213011, 3942.4144694553534]))
    data23.append((1, [68.6675147973001, 334.53257000325681, 335.40871716002556, 75.173662260174751, 3501.8022131818743, 3950.858884465285, 4089.2202195612822, 4620.9269418389022]))
    data23.append((10,[185.82684067357332, 926.82319453489959, 970.13549641706607, 192.28590429993346, 3531.3599368377199, 3960.492301592235, 3921.6076684839395, 4407.8212162011951]))
    data23.append((30,[225.09237549453974, 1120.7180119604411, 1176.9828030229025, 281.39693160261959, 3542.685107377451, 3952.9124653531139, 3840.9806016416496, 4294.564213918311]))
    data23.append((100,[260.2377685875399, 1293.4519083899213, 1389.3787633960726, 532.12062722456176, 3569.1675710061413, 3942.983250818867, 3679.8884355542559, 4067.3988688565682]))
    data23.append((300,[256.48927219494635, 1284.7552822342561, 1375.8397447763366, 587.46535055773347, 3604.7361893580032, 3973.6822988592762, 3689.8308429805538, 4071.0860555263616]))
    data.append(data23)
...
if QAC.select(11,select,"Difference plot niter=10000 combine2 and combine4"):
    ...
    # some issues if axes are same and what channel to pick..... wait to settle on final bench
    chan = 15 
    chan = 69-15
    if False:
        # this *should* be there default
        qac_plot_grid([im2,im4], chan, QAC.iarray(box1), diff=10,plot='M100_final11.png')
    else:
        qac_plot_grid([im2,im5], chan, QAC.iarray(box1), diff=10,plot='M100_final11.png')
