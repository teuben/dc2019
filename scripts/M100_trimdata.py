...
#
#  The original M100 data, as described in the casaguide, are rather big.
#
...
#  data, as it's used by the 2 minute tp2vis benchmark in QAC.
#  An earlier version of the benchmark is based on CASA4 , but this script has been updated to
...
# the M100_aver_12.ms dataset has a missing getcol::REST_FREQUENCY
if True:
    tb.open(ms1q + '/SOURCE', nomodify=False)
    rf = np.array([[115.271204e9]])
    rf = np.array([[115.271e9]])
