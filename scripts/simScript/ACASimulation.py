...
if not inbright: 
    ...
    print " "
    rmsVis = aU.sensitivity(incenter, inwidth, integration, pwv=pwv, antennalist = config[0])
    maxval = rmsVis*snr # Maximum pixel value in skymodel 
    inbright = str(maxval)+" Jy/pixel" # This is rough estimate (i.e. beamsize is not considered) 
    autoSens=True
...
if autoSens:
  print "# 12m Array sensitivity [Jy] = ", rmsVis
